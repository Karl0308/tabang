                      ...
                      <div className="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg p-3 text-sm text-gray-500">
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                          {c.ticketAttachments.map((att : any, index) => (
                            <div
                              key={att.id}
                              className="relative cursor-pointer rounded-md overflow-hidden border border-gray-200 dark:border-gray-600 hover:shadow-lg transition-all duration-200 p-1 flex flex-col items-center bg-white dark:bg-gray-700"
