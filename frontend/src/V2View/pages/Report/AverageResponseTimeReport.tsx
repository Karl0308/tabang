...
const AverageResponseTimeReport = () => {
    ...
    const fetchData = () => {
        ...
        setIsLoading(true);
        axiosInstance.post(APIURLS.report.getAverageReports(), transformedFilter)
            .then((res) => {
    ...
    const exportTableAsPDF = () => {
        ...
        const title = `Average Response Time Report`;
        ...
        const averageResponseTime = `Average Response Time`;
        ...
        const filename = `tabang-response-pdf-reports-${formattedDate}.pdf`;
                    ...
                    <thead>
                        <tr>
                            ...
                            <th className="px-6 py-3 bg-gray-100 text-left text-xs font-bold text-gray-600 uppercase tracking-wider cursor-pointer dark:bg-gray-800 dark:text-white dark:border-gray-700" onClick={() => handleOrder('responseTime')}>
                                Response Time {orderBy === 'responseTime' && (orderDesc ? '↓' : '↑')}
                            </th>
                        </tr>
                    </thead>
                    <tbody>
